...
def objective(trial, args):
    ...
    hyperparams = {
        ...
        'early_stop_counter_pretrain': trial.suggest_int('early_stop_counter_pretrain', sp['early_stop_counter_pretrain'][0], sp['early_stop_counter_pretrain'][1]),
        ...
        'early_stop_counter_ft': trial.suggest_int('early_stop_counter_ft', sp['early_stop_counter_ft'][0], sp['early_stop_counter_ft'][1]),
    }
...
# --checkpoint_path tune_shoppers --epochs_latent 200 --epochs_fine_tuning_latent 0 --batch_size 4096 
    ...
    args.search_space = {
        ...
        'factor': [16, 32],
        'num_layers': [1, 2],
        'early_stop_counter_pretrain': [5, 20],
        'dropout_ft': [0.1, 0.2, 0.3],
        'alpha_ft': [0.3, 0.5, 0.7],
        'lr_ft': [1e-5, 1e-3],
        'wd_ft': [0,1e-4,1e-3],
        'early_stop_counter_ft': [5, 10],
    }
